...
#      define KCONFIGCORE_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KCONFIGCORE_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#define KCONFIGCORE_BUILD_DEPRECATED_SINCE(major, minor) 0

#ifdef KCONFIGCORE_NO_DEPRECATED
#  define KCONFIGCORE_DISABLE_DEPRECATED_BEFORE_AND_AT 0x54d00
#endif
...
#  else
#    define KCONFIGCORE_DEPRECATED_WARNINGS_SINCE 0x54d00
#  endif
#endif
...
#if KCONFIGCORE_DEPRECATED_WARNINGS_SINCE >= 0x40000
...
#if KCONFIGCORE_DEPRECATED_WARNINGS_SINCE >= 0x50000
...
#if KCONFIGCORE_DEPRECATED_WARNINGS_SINCE >= 0x51800
...
#if KCONFIGCORE_DEPRECATED_WARNINGS_SINCE >= 0x52a00
